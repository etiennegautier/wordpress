...
$of_options[] = array( "name" => "Theme Documentation",
					...
					"std" => '<p>Knowledge is Power! You can rely on the online <a href="http://support.getbowtied.com/the-retailer/" target="_blank">Theme Documentation &rarr;</a> as you move further with building your site. It covers all the steps of configuring the navigation, importing the dummy data, building the pages and so on.</p><p>Always feel free to get back to it. We update it as much as we can with valuable information whenever is needed. <br /><br /><a class="button-primary" href="http://support.getbowtied.com/the-retailer/" target="_blank">Theme Documentation &rarr;</a></p>',
					"icon" => true,
					"type" => "info");	
