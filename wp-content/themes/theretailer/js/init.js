...
jQuery(document).ready(function($) {
	...
	$(".shopping_bag_centered_style").live("mouseenter", function() {
		if(!$(this).data('init'))
        {
            $(this).data('init', true);
            $(this).hoverIntent
	...
	$('.custom_show_review_form').click(function () {		
		...
		$('#global_wrapper').hide();
		//$('#global_wrapper').css('height', 0);
		//$('#global_wrapper').css('overflow', 'hidden');
	});
	
	$('#review_form_wrapper_overlay_close').click(function () {		
		$("#review_form_wrapper_overlay").hide();
		$('#global_wrapper').show();
		//$('#global_wrapper').css('height', '100%');
		//$('#global_wrapper').css('overflow', 'inherit');
	});
	
	/*$('.gbtr_menu_mobiles').click(function () {		
		$("#mobile_menu_overlay").addClass("open");
		$("#mobile_menu_overlay_inside").addClass("open");
		$('#global_wrapper').css('height', 0);
		$('#global_wrapper').css('overflow', 'hidden');
		setTimeout(function() {
			$('#mobile_menu_overlay_close').show();
		},600);
		$('html').addClass('mobile_menu_overlay_open');
	});
	
	$('#mobile_menu_overlay_close').click(function () {		
		$("#mobile_menu_overlay").removeClass("open");
		$("#mobile_menu_overlay_inside").removeClass("open");
		$('#global_wrapper').css('height', 'inherit');
		$('#global_wrapper').css('overflow', 'inherit');
		$('#mobile_menu_overlay_close').hide();
		$('html').removeClass('mobile_menu_overlay_open');
	});*/
