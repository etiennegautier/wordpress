        ...
        <div class="grtr_product_header_mobiles">
            ...
            if ( comments_open() ) {
                ...
                if ( $count > 0 ) {
                    ...
                    echo '<div class="after_title_reviews"><div class="reviews_nr">' . $count . ' ' . __('Reviews', 'theretailer') . '</div><div class="star-rating" title="'.sprintf(__('Rated %s out of 5', 'theretailer'), $average).'"><span style="width:'.($average*16).'px"><span itemprop="ratingValue" class="rating">'.$average.'</span> '.__('out of 5', 'theretailer').'</span></div><div class="clr"></div></div>';
