    ...
    <div class="gbtr_my_account_wrapper">
        ...
        <div class="grid_8 alpha omega">
            ...
            <div class="grid_8 omega">
                ...
                <ul class="gbtr_digital-downloads">
                    <?php foreach ($downloads as $download) : ?>
                        <li><i class="fa fa-cloud-download"></i><?php if (is_numeric($download['downloads_remaining'])) : ?><span class="count"><?php echo $download['downloads_remaining'] . _n('&nbsp;download remaining', '&nbsp;downloads remaining', $download['downloads_remaining'], 'theretailer'); ?></span><?php endif; ?> <a href="<?php echo esc_url( $download['download_url'] ); ?>"><?php echo $download['download_name']; ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
            <?php endif; ?>
