                    ...
                    foreach ($customer_orders as $customer_order) :
                        ...
                        ?><tr class="order">
                            ...
                            <td class="order-status">
                                <?php echo ucfirst( __( $status->name, 'theretailer' ) ); __( 'pending', 'theretailer' ); __( 'failed', 'theretailer' ); __( 'on-hold', 'theretailer' ); __( 'processing', 'theretailer' ); __( 'completed', 'theretailer' ); __( 'refunded', 'theretailer' ); __( 'cancelled', 'theretailer' ); ?>
